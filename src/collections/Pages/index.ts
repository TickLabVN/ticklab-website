...
import { CoreValue } from '../../blocks/CoreValue/config'
          ...
          fields: [
            {
              name: 'layout',
              type: 'blocks',
              blocks: [CallToAction, Content, MediaBlock, Archive, FormBlock, MissionSection, RoleSection, CoreValue, SliderSection, Team, FAQ, Blog],
              required: true,
              admin: {
                initCollapsed: true,
              },
