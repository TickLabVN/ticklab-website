  ...
  return (
    <section className="relative w-full min-h-[90vh] flex items-center justify-center overflow-hidden bg-white">
      <div className="absolute inset-0 w-full h-full">
        <Image
          src="/media/ticklab-background.png"
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          >
            ...
            <p className="mx-auto max-w-[800px] text-lg md:text-xl text-gray-600">
              We are a career development organization dedicated to supporting talented students who
              aspire to contribute to the growth of our nation&apos;s construction{' '}
            </p>{' '}
          </motion.div>
        </div>
      </div>
