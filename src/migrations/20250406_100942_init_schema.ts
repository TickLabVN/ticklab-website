...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  -- CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact', 'customImpact');
  ...
  -- CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact', 'customImpact');
  -- CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  -- CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  -- CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  -- CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'member');
  -- CREATE TYPE "public"."enum_projects_category" AS ENUM('Web', 'Mobile', 'AI', 'Machine Learning', 'Blockchain');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_mission_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"vision_title" varchar DEFAULT 'Vision',
  	"vision_content" varchar DEFAULT 'To become a good launcher for the process of moral cultivation, skill building and training of the excellent Vietnamese human qualities. Talent without virtue is useless, virtue without talent makes everything difficult
  ...
  To develop resources and contribute to the country''''s construction and renovation, fostering individuals who create value, solve challenges, and elevate the nation''''s global standing.',
  	...
  	"mission_content" varchar DEFAULT 'To establish, maintain, and develop a comprehensive development environment for generations of students. TickLab will always be a human development organization.
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_role_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"engineering_title" varchar DEFAULT 'ENGINEERING',
  	"engineering_content" varchar DEFAULT 'Engineers at TickLab apply scientific and technical knowledge to solve real-world problems, considering safety, reliability, and cost-effectiveness. The focus is on providing a broad range of experiences across different engineering disciplines, rather than specializing in a single area early on. This includes various software development roles (Frontend, Backend, DevOps, Mobile) and hardware/IoT/logic design roles (Embedded Systems, Hardware Design, Digital IC Design).',
  	"engineering_image_id" integer,
  	"research_title" varchar DEFAULT 'RESEARCH',
  	"research_content" varchar DEFAULT 'Researchers at TickLab are envisioned as future pioneers in science and technology, fostered within a professional research environment that values learning, practical application of theoretical knowledge, and contribution to both research and organizational development. The current research focus areas are Computer Vision, Reinforcement Learning, and Text-to-Speech.',
  	"research_image_id" integer,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_core_value_values" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_core_value" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'CORE VALUES',
  	"description" varchar DEFAULT 'Our core values define our identity and drive our actions. They reflect our commitment to excellence, integrity, collaboration, innovation, and growth. These values form the foundation of our culture and guide our decisions every day.',
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_slider_section_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_slider_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'What We''''ve Achieved',
  	"description" varchar DEFAULT 'Showcasing Innovations and Milestones in Engineering and Research',
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_team_photos" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_team" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'OUR TEAMS',
  	"description" varchar DEFAULT 'Meet our passionate team members who drive innovation and excellence across different projects and initiatives.',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_faq" (
  	...
  	"description" varchar DEFAULT 'Quick insights into TickLab''''s structure, culture, and activities.',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_blog" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'Our Blogs',
  	"description" varchar DEFAULT 'Explore the Latest in TickLab Development, Integration, and Innovation',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages" (
  	...
  	"title" varchar,
  	"hero_type" "enum_pages_hero_type" DEFAULT 'customImpact',
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_mission_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_role_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_core_value_values" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_core_value" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_slider_section_slides" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_slider_section" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_team_photos" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_faq_questions" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"question" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v" (
  	...
  	"version_hero_type" "enum__pages_v_version_hero_type" DEFAULT 'customImpact',
  ...
  CREATE TABLE IF NOT EXISTS "users" (
  	...
  	"avatar_id" integer,
  	"bio" jsonb,
  	"infomation_github" varchar,
  	"infomation_linkedin" varchar,
  	"infomation_phone" varchar,
  	"infomation_email" varchar,
  	"infomation_major" varchar,
  	"infomation_position" varchar,
  	"infomation_university" varchar,
  	"infomation_cv_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "projects" (
  	...
  	"posts_id" integer,
  	"image_id" integer,
  	"category" "enum_projects_category" DEFAULT 'Web' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE IF NOT EXISTS "footer_resources" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"contact_email" varchar DEFAULT 'ticklab.vn@gmail.com',
  	"contact_address" varchar DEFAULT ' 177/19 đường số 6, khu phố Tân Lập, P. Đông Hoà, TP. Dĩ An, tỉnh Bình Dương',
  	"contact_facebook" varchar DEFAULT 'https://www.facebook.com/ticklab.vn',
  	"contact_github" varchar DEFAULT 'https://github.com/TickLabVN',
  	"contact_youtube" varchar DEFAULT 'https://www.youtube.com/@TickLab',
  	"logo_id" integer NOT NULL,
  	"company_name" varchar DEFAULT 'TickLab',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_role_section" ADD CONSTRAINT "pages_blocks_role_section_engineering_image_id_media_id_fk" FOREIGN KEY ("engineering_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_role_section" ADD CONSTRAINT "pages_blocks_role_section_research_image_id_media_id_fk" FOREIGN KEY ("research_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_role_section" ADD CONSTRAINT "pages_blocks_role_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_core_value_values" ADD CONSTRAINT "pages_blocks_core_value_values_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_core_value"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_core_value" ADD CONSTRAINT "pages_blocks_core_value_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_slider_section_slides" ADD CONSTRAINT "pages_blocks_slider_section_slides_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_slider_section_slides" ADD CONSTRAINT "pages_blocks_slider_section_slides_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_slider_section"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_slider_section" ADD CONSTRAINT "pages_blocks_slider_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_team_photos" ADD CONSTRAINT "pages_blocks_team_photos_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_team_photos" ADD CONSTRAINT "pages_blocks_team_photos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_team"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_blog_posts" ADD CONSTRAINT "pages_blocks_blog_posts_author_avatar_id_media_id_fk" FOREIGN KEY ("author_avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_mission_section" ADD CONSTRAINT "_pages_v_blocks_mission_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_role_section" ADD CONSTRAINT "_pages_v_blocks_role_section_engineering_image_id_media_id_fk" FOREIGN KEY ("engineering_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_role_section" ADD CONSTRAINT "_pages_v_blocks_role_section_research_image_id_media_id_fk" FOREIGN KEY ("research_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_role_section" ADD CONSTRAINT "_pages_v_blocks_role_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_core_value_values" ADD CONSTRAINT "_pages_v_blocks_core_value_values_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_core_value"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_core_value" ADD CONSTRAINT "_pages_v_blocks_core_value_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_slider_section_slides" ADD CONSTRAINT "_pages_v_blocks_slider_section_slides_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_slider_section_slides" ADD CONSTRAINT "_pages_v_blocks_slider_section_slides_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_slider_section"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_slider_section" ADD CONSTRAINT "_pages_v_blocks_slider_section_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_team_photos" ADD CONSTRAINT "_pages_v_blocks_team_photos_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_team_photos" ADD CONSTRAINT "_pages_v_blocks_team_photos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_team"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_blog_posts" ADD CONSTRAINT "_pages_v_blocks_blog_posts_author_avatar_id_media_id_fk" FOREIGN KEY ("author_avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "users_activities" ADD CONSTRAINT "users_activities_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "projects" ADD CONSTRAINT "projects_posts_id_posts_id_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "footer_resources" ADD CONSTRAINT "footer_resources_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_mission_section_order_idx" ON "pages_blocks_mission_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_mission_section_parent_id_idx" ON "pages_blocks_mission_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_mission_section_path_idx" ON "pages_blocks_mission_section" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_role_section_order_idx" ON "pages_blocks_role_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_role_section_parent_id_idx" ON "pages_blocks_role_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_role_section_path_idx" ON "pages_blocks_role_section" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_role_section_engineering_image_idx" ON "pages_blocks_role_section" USING btree ("engineering_image_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_role_section_research_image_idx" ON "pages_blocks_role_section" USING btree ("research_image_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_core_value_values_order_idx" ON "pages_blocks_core_value_values" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_core_value_values_parent_id_idx" ON "pages_blocks_core_value_values" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_core_value_order_idx" ON "pages_blocks_core_value" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_core_value_parent_id_idx" ON "pages_blocks_core_value" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_core_value_path_idx" ON "pages_blocks_core_value" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_slider_section_slides_order_idx" ON "pages_blocks_slider_section_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_slider_section_slides_parent_id_idx" ON "pages_blocks_slider_section_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_slider_section_slides_image_idx" ON "pages_blocks_slider_section_slides" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_slider_section_order_idx" ON "pages_blocks_slider_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_slider_section_parent_id_idx" ON "pages_blocks_slider_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_slider_section_path_idx" ON "pages_blocks_slider_section" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_team_photos_order_idx" ON "pages_blocks_team_photos" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_team_photos_parent_id_idx" ON "pages_blocks_team_photos" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_team_photos_image_idx" ON "pages_blocks_team_photos" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_faq_questions_order_idx" ON "pages_blocks_faq_questions" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_faq_questions_parent_id_idx" ON "pages_blocks_faq_questions" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_blog_posts_image_idx" ON "pages_blocks_blog_posts" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_blog_posts_author_author_avatar_idx" ON "pages_blocks_blog_posts" USING btree ("author_avatar_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_mission_section_order_idx" ON "_pages_v_blocks_mission_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_mission_section_parent_id_idx" ON "_pages_v_blocks_mission_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_mission_section_path_idx" ON "_pages_v_blocks_mission_section" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_role_section_order_idx" ON "_pages_v_blocks_role_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_role_section_parent_id_idx" ON "_pages_v_blocks_role_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_role_section_path_idx" ON "_pages_v_blocks_role_section" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_role_section_engineering_image_idx" ON "_pages_v_blocks_role_section" USING btree ("engineering_image_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_role_section_research_image_idx" ON "_pages_v_blocks_role_section" USING btree ("research_image_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_core_value_values_order_idx" ON "_pages_v_blocks_core_value_values" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_core_value_values_parent_id_idx" ON "_pages_v_blocks_core_value_values" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_core_value_order_idx" ON "_pages_v_blocks_core_value" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_core_value_parent_id_idx" ON "_pages_v_blocks_core_value" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_core_value_path_idx" ON "_pages_v_blocks_core_value" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_slider_section_slides_order_idx" ON "_pages_v_blocks_slider_section_slides" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_slider_section_slides_parent_id_idx" ON "_pages_v_blocks_slider_section_slides" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_slider_section_slides_image_idx" ON "_pages_v_blocks_slider_section_slides" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_slider_section_order_idx" ON "_pages_v_blocks_slider_section" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_slider_section_parent_id_idx" ON "_pages_v_blocks_slider_section" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_slider_section_path_idx" ON "_pages_v_blocks_slider_section" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_team_photos_order_idx" ON "_pages_v_blocks_team_photos" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_team_photos_parent_id_idx" ON "_pages_v_blocks_team_photos" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_team_photos_image_idx" ON "_pages_v_blocks_team_photos" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_faq_questions_order_idx" ON "_pages_v_blocks_faq_questions" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_faq_questions_parent_id_idx" ON "_pages_v_blocks_faq_questions" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_blog_posts_image_idx" ON "_pages_v_blocks_blog_posts" USING btree ("image_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_blog_posts_author_author_avatar_idx" ON "_pages_v_blocks_blog_posts" USING btree ("author_avatar_id");
  ...
  CREATE INDEX IF NOT EXISTS "users_activities_order_idx" ON "users_activities" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "users_activities_parent_id_idx" ON "users_activities" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "users_rels_posts_id_idx" ON "users_rels" USING btree ("posts_id");
  ...
  CREATE INDEX IF NOT EXISTS "projects_posts_idx" ON "projects" USING btree ("posts_id");
  ...
  CREATE INDEX IF NOT EXISTS "footer_resources_order_idx" ON "footer_resources" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "footer_resources_parent_id_idx" ON "footer_resources" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_role_section" CASCADE;
  DROP TABLE "pages_blocks_core_value_values" CASCADE;
  DROP TABLE "pages_blocks_core_value" CASCADE;
  DROP TABLE "pages_blocks_slider_section_slides" CASCADE;
  DROP TABLE "pages_blocks_slider_section" CASCADE;
  DROP TABLE "pages_blocks_team_photos" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_mission_section" CASCADE;
  DROP TABLE "_pages_v_blocks_role_section" CASCADE;
  DROP TABLE "_pages_v_blocks_core_value_values" CASCADE;
  DROP TABLE "_pages_v_blocks_core_value" CASCADE;
  DROP TABLE "_pages_v_blocks_slider_section_slides" CASCADE;
  DROP TABLE "_pages_v_blocks_slider_section" CASCADE;
  DROP TABLE "_pages_v_blocks_team_photos" CASCADE;
  ...
  DROP TABLE "users_activities" CASCADE;
  ...
  DROP TABLE "footer_resources" CASCADE;
